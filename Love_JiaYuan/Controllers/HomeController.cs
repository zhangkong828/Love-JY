...
namespace Love_JiaYuan.Controllers
{
    public class HomeController : Controller
    {
        ...
        {
            var sex = Request.Form["sex"] == null ? "f" : Request.Form["sex"];
            ...
            string postdata = string.Format("sex={4}&key=&stc=1:{0},2:{1}.{2},23:1&sn=default&sv=1&p={3}&f=select&listStyle=bigPhoto&pri_uid=0&jsversion=v5", area, ages, agee, pageindex,sex);
        ...
        {
            var sex = Request.QueryString["sex"] == null ? "f" : Request.QueryString["sex"];
